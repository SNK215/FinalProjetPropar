 ...
 */
class getChiffreAffaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChiffreAffaireRepository' shared autowired service.
     *
     * @return \App\Repository\ChiffreAffaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChiffreAffaireRepository.php';

        return $container->privates['App\\Repository\\ChiffreAffaireRepository'] = new \App\Repository\ChiffreAffaireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
