...
class getDataTableFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Omines\\DataTablesBundle\\DataTableFactory'] = new \Omines\DataTablesBundle\DataTableFactory($container->parameters['datatables.config'], new \Omines\DataTablesBundle\Twig\TwigRenderer(($container->services['twig'] ?? $container->getTwigService())), new \Omines\DataTablesBundle\DependencyInjection\Instantiator(['Omines\\DataTablesBundle\\Adapter\\AdapterInterface' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
        ...
        ]), 'Omines\\DataTablesBundle\\DataTableTypeInterface' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [], []), 'Omines\\DataTablesBundle\\Exporter\\DataTableExporterInterface' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
        ...
        }, 2)), ($container->services['translator'] ?? $container->getTranslatorService())));
    }
}
